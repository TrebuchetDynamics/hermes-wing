...
3. In Navivox, open `/hermes` and enter the endpoint plus the API key. Plain HTTP with credentials requires explicit confirmation and can expose traffic outside a trusted encrypted or isolated network.
