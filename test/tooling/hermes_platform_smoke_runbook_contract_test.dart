...
void main() {
  test('Hermes platform smoke runbook preserves host and voice boundaries', () {
    ...
    for (final snippet in [
      ...
      'run `28731694618`',
      'Earlier local-only\nYAML and missing-`workflow`-scope push failures are historical non-receipts',
      ...
      'successful Windows desktop, iOS simulator,\nand macOS desktop native-host jobs plus artifact metadata',
